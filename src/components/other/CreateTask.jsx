        ...
        <form className="flex flex-wrap w-full  items-start justify-between">
          <div className="w-1/2">
            ...
            <div>
              ...
              <input className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="design,dev,ets" />
            </div>
          </div>
          ...
          <div className="w-2/5 flex flex-col items-start">
            ...
            <textarea className="text-sm py-2 px-4 w-full h-44 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4"  name="" id="" cols="30" rows="10"></textarea>
